<template>
    <div class="flex justify-start mt-12 relative">
        <div class="w-2/5">
        ...
        <div class="w-3/5 ml-6 h-full">
            <div class="flex">
                ...
                <div class="w-1/2 flex justify-end">
                    <img @click="handleTapImage(item.titleImage)" class="w-56 ml-9 object-contain hover:cursor-pointer"
                        :src="item.titleImage" />
                </div>
            </div>
            ...
            <div class="w-full mb-4">
                <div class="absolute bottom-0 right-0 mb-4 flex">
                    <template v-for="image in item.imageList">
                        <img @click="handleTapImage(image)" class="w-56 ml-9 object-contain hover:cursor-pointer"
                            :src="image" />
                    </template>
                </div>
            </div>
